...
/// Default heading patterns the integration tests pass to `extract`.
/// Mirrors the shipped `headings.toml` default.
pub fn default_heading_patterns() -> HeadingPatterns {
