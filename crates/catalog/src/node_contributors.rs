...
pub(crate) const SPEC: TableSpec = TableSpec {
    ...
    columns: &[
        ...
        ColumnSpec::text("family").comment("CSL-JSON structured name: family component"),
        ColumnSpec::text("given").comment("CSL-JSON structured name: given component"),
        ColumnSpec::text("orcid").comment("ORCID iD, e.g. `0000-0002-1825-0097`"),
    ],
    composite_pk: None,
