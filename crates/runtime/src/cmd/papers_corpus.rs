...
//!
//! Mirrors [`crate::cmd::corpus`] for the paper pipeline: the same
//! two-entry-point shape, with [`rebuild`] driving the in-process
//! REPL path and [`plan_rebuild`] + [`execute_rebuild_from_plan`]
//! powering the daemon's pinned two-phase RPC protocol.
