...
- **mcp, runtime: TOC reads gain a `title_substring` filter.**
  ...
  whose title contains a substring (ASCII case is ignored; `LIKE`
...
[0.6.1]: https://github.com/Collegium-Siderum/bookrack/compare/v0.6.0...v0.6.1
[0.6.0]: https://github.com/Collegium-Siderum/bookrack/compare/v0.5.0...v0.6.0
